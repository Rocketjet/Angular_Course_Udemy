  ...
  loadRecipes() {
    return this.authService.user$
      .pipe(
        ...
        exhaustMap(user => {//чекає поки завершиться перший Observable (user$), отримує як параметр його дані і замінює його в ланцюгу Observables на внутрішній, тобто той, що буде повернуто викликом this.http.get(). Тобто в результаті метод loadRecipes() поверне Observable з масивом рецептів. 
