...
const routes: Routes = [
  ...
  {
    path: 'recipes', component: RecipesComponent, children: [//потрібно пам'ятати, що порядок {path} важливий, динамічні параметри в кінці масиву повинні бути, щоб шлях правильно парсився
